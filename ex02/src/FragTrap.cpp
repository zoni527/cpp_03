...
: ClapTrap( HIBRED "sane_default" RESET, 100, 100, 30 ) {
	std::cout << frag_trap_str + " default constructor called\n";
	std::cout
		<< "A " + frag_trap_str + " named " << _name << " has spawned into the map"
		<< std::endl;
}

FragTrap:: FragTrap( std::string const &name )
: ClapTrap( HIBRED + name + RESET, 100, 100, 30 ) {
	std::cout << frag_trap_str + " string constructor called\n";
	std::cout
		<< "A " + frag_trap_str + " named " << _name << " has spawned into the map"
		<< std::endl;
}
...
: ClapTrap( src ) {
	std::cout << frag_trap_str + " copy constructor called\n";
	std::cout
		<< "A " + frag_trap_str + " named " << _name << " has spawned into the map"
		<< std::endl;
}
...
FragTrap:: ~FragTrap( void ) {
	std::cout << frag_trap_str + " destructor called\n";
	std::cout
		<< "A " + frag_trap_str + " named " << _name << " has left the map" << std::endl;
}
